...
namespace Beedev.Xrm.CrmSvcUtil.Extensions.Naming
{
  ...
  public class NamingServiceTests
  {
    ...
    public void GetNameForEntityTest()
    {
      ...
      EntityMetadata acountMetadata = JsonConvert.DeserializeObject<EntityMetadata>("{\"SchemaName\":\"Account\", \"CollectionSchemaName\":\"AccountSet\", \"Attributes\":[{}]}");
      EntityMetadata sampleEntityMetadata = JsonConvert.DeserializeObject<EntityMetadata>("{\"SchemaName\":\"beedev_SampleEntity\", \"CollectionSchemaName\":\"beedev_SampleEntitySet\", \"Attributes\":[]}");
      acountMetadata.Attributes[0] = new PicklistAttributeMetadata("beedev_") { SchemaName  ="Name", OptionSet = new OptionSetMetadata{MetadataId = new Guid("0B707C29-9305-43A3-B1C6-04C60CDEA04A")}};
      ...
      Assert.AreEqual("AccountName", namingService.GetNameForOptionSet(acountMetadata, new OptionSetMetadata { Name = "AnInternalName", MetadataId = new Guid("0B707C29-9305-43A3-B1C6-04C60CDEA04A") }, _serviceProvider));
      Assert.AreEqual("AccountName", namingService.GetNameForOptionSet(acountMetadata, new OptionSetMetadata { Name = "beedev_AnInternalName", MetadataId = new Guid("0B707C29-9305-43A3-B1C6-04C60CDEA04A") }, _serviceProvider));
      ...
      Assert.AreEqual("_20H", namingService.GetNameForOption(new OptionSetMetadata(), new OptionMetadata { Label = new Label("20H", 1033) { UserLocalizedLabel = new LocalizedLabel("20H", 1033) } }, _serviceProvider));
